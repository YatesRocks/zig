...
pub fn build(b: *std.Build) void {
    ...
    const run_chmod_step = if (host_target.result.isDarwin()) steps: {
        ...
        chmod_exe.step.max_rss = 259_588_096;
    ...
    const build_cc_stage2_step = if (b.option(
        ...
        build_bootstrap.step.max_rss = 93_941_760;
...

    {
        ...
        msvc: {
            ...
            build_msvc_compiler_rt.step.max_rss = 186_867_712;
            ...
            run_msvc_tests.step.max_rss = 6_463_488;
